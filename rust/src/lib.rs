//! Windissect-generated Rust FFI bindings for TileDataRepository.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "0A2D5857C065B0B76A6F8CF280AC149F";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 827127013;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 23] = [84, 105, 108, 101, 68, 97, 116, 97, 82, 101, 112, 111, 115, 105, 116, 111, 114, 121, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 827127013 { return 0; }
