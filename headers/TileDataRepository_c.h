// Flat C exports observed in TileDataRepository.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef TILEDATAREPOSITORY_C_H
#define TILEDATAREPOSITORY_C_H
