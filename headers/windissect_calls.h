...
static constexpr wchar_t module_name[23] = {0x0054, 0x0069, 0x006C, 0x0065, 0x0044, 0x0061, 0x0074, 0x0061, 0x0052, 0x0065, 0x0070, 0x006F, 0x0073, 0x0069, 0x0074, 0x006F, 0x0072, 0x0079, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 827127013U || rva >= image_size) return nullptr;
return base + rva;
}
